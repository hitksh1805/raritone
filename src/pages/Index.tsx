  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'var(--main-bg)' }}>
      ...
      <div className="relative min-h-screen overflow-hidden flex items-center justify-center">
        ...
        {/* Deep charcoal gradient overlay for better text readability */}
        <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-[#1A1A19]/20 to-[#121212]/80" style={{ zIndex: 2 }} />
          ...
          <div className="p-8 sm:p-12 lg:p-16">
            <div className="mb-8">
              <img
                ...
                id="hero-logo"
                style={{
                  filter: 'drop-shadow(0 0 60px rgba(242, 238, 215, 0.6)) brightness(1.4) contrast(1.1)',
                }}
              />
            </div>

            <h1 className="hero-title mb-6 opacity-0" id="hero-heading" style={{ transition: 'opacity 0.6s ease, transform 0.6s ease' }}>
            ...
            <div className="max-w-lg mx-auto">
              <p className="text-sm px-6 py-3 rounded-xl border border-[var(--border-color)] bg-[var(--secondary-bg)]/50 backdrop-blur-md text-[var(--text-secondary)]">
      ...
      <section className="section-spacing overflow-hidden" style={{ background: 'rgba(35, 35, 35, 0.5)' }}>
      ...
      <footer className="section-spacing border-t-2 border-[var(--border-color)]" style={{ background: 'var(--charcoal, #121212)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="luxury-card rounded-2xl p-8" style={{ background: 'var(--main-bg)' }}>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="lg:col-span-2">
                ...
                <div className="flex space-x-4">
                  {/* Instagram Icon */}
                  <div className="w-12 h-12 rounded-full border-2 border-[var(--border-color)] flex items-center justify-center hover:bg-[var(--accent-color)] transition-all cursor-pointer group" style={{ background: 'transparent' }}>
                    <svg className="w-6 h-6 text-[var(--text-primary)] group-hover:text-[var(--main-bg)] transition-colors" fill="currentColor" viewBox="0 0 24 24" style={{ filter: 'drop-shadow(0 0 8px rgba(242, 238, 215, 0.3))' }}>
            ...
            <div className="border-t border-[var(--border-color)] mt-12 pt-8 text-center" style={{ borderWidth: '1px', opacity: 0.3 }}>
              <p className="text-[var(--text-primary)] text-base" style={{ opacity: 0.8 }}>
